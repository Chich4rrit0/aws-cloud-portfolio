...
| 4 | Lambda | `portfolio-p02-link-shortener`; `nodejs22.x`; `arm64`; 128 MiB; timeout 3 s; concurrencia reservada 0 hasta aprobar pruebas; variable `LINKS_TABLE_NAME`. | Ejecutar el handler con una pausa de seguridad previa a la exposición. | Invocaciones y duración. |
